...
var createMutations = function createMutations(_ref) {
    var mutations = _ref.mutations,
        ...
        onReplaceListStart = _ref.onReplaceListStart,
        onReplaceListSuccess = _ref.onReplaceListSuccess,
        onReplaceListError = _ref.onReplaceListError,
    ...
    if (only.includes('FETCH_LIST')) {
        Object.assign(crudMutations, {
            ...
            fetchListSuccess: function fetchListSuccess(state, response) {
                ...
                state.list = Object.values(state.entities).map(function (m) {
    ...
    if (only.includes('REPLACE_LIST')) {
        Object.assign(crudMutations, {
            replaceListStart: function replaceListStart(state) {
                state.isReplacingList = true;
                onReplaceListStart(state);
            },
            replaceListSuccess: function replaceListSuccess(state, response) {
                var data = response.data;
            ...
            replaceListError: function replaceListError(state, err) {
