...
var createActions = function createActions(_ref) {
  ...
  if (only.includes(REPLACE_LIST)) {
    Object.assign(crudActions, {
      ...
      * Fetch list of resources.
      */
      replaceList: function replaceList(_ref13) {
        ...
        return client.get(urlGetter({ customUrl: customUrl, customUrlFnArgs: customUrlFnArgs, type: REPLACE_LIST }), config).then(function (res) {
          var parsedResponse = parseList(res);
  ...
  if (only.includes(DESTROY)) {
    Object.assign(crudActions, {
       ...
       */
      destroy: function destroy(_ref15) {
        var commit = _ref15.commit;

        var _ref16 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
            id = _ref16.id,
            config = _ref16.config,
            customUrl = _ref16.customUrl,
            _ref16$customUrlFnArg = _ref16.customUrlFnArgs,
            customUrlFnArgs = _ref16$customUrlFnArg === undefined ? [] : _ref16$customUrlFnArg;
