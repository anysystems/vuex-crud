...
var createCrud = function createCrud() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$onReplaceListSta = _ref.onReplaceListStart,
      onReplaceListStart = _ref$onReplaceListSta === undefined ? function () {} : _ref$onReplaceListSta,
      _ref$onReplaceListSuc = _ref.onReplaceListSuccess,
      onReplaceListSuccess = _ref$onReplaceListSuc === undefined ? function () {} : _ref$onReplaceListSuc,
      _ref$onReplaceListErr = _ref.onReplaceListError,
      onReplaceListError = _ref$onReplaceListErr === undefined ? function () {} : _ref$onReplaceListErr,
      ...
      _ref$only = _ref.only,
      only = _ref$only === undefined ? ['FETCH_LIST', 'FETCH_SINGLE', 'CREATE', 'UPDATE', 'REPLACE', 'REPLACE_LIST', 'DESTROY'] : _ref$only,
  ...
  */
  ...
  return {
    ...
    mutations: (0, _createMutations2.default)({
      ...
      onReplaceListStart: onReplaceListStart,
      onReplaceListSuccess: onReplaceListSuccess,
      onReplaceListError: onReplaceListError,
